...
# API_KEY OR sys.argv[1] has to be 'AIzaSyCUpsVmstNjllVHEasA4wlXp-nJCJ3HhS8'
api_key = sys.argv[1]
print ('API_KEY IS:_',api_key)
print ('*' * 100)
...
request=service.volumes().list(userId='101020739555953201084',shelf='0')
